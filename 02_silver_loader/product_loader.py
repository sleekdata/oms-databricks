...
bronze_products_df = spark.read.table("oms_analytics.01_bronze.product")
...
products_silver_df.write.format("delta").mode("overwrite").saveAsTable("oms_analytics.02_silver.product")
