...
product_subcategory_df = spark.read.table("postgres_federated_db.oms_schema.product_subcategory")
...
product_subcategory_transformed_df.write.format("delta").mode("overwrite").saveAsTable("oms_analytics.01_bronze.product_subcategory")
